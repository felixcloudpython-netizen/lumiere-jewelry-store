import { PrismaClient, Metal } from '@prisma/client';
...
async function main() {
  ...
  if (!process.env.ADMIN_EMAIL || !process.env.ADMIN_PASSWORD) {
    console.warn(
      '⚠️  ADMIN_EMAIL/ADMIN_PASSWORD chưa được set trong env — đang dùng giá trị mặc định ' +
